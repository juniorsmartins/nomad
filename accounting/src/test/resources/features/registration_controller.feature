...
Funcionalidade: testar operações CRUD do RegistrationController
  ...
  Contexto:
    ...
    Cenario: Post para criar Registration com sucesso
      ...
      Entao receberei um ResponseEntity com HTTP 201 do RegistrationController
    ...
    Cenario: Get para consultar Registration com sucesso
      ...
      Entao receberei um ResponseEntity com HTTP 200 do RegistrationController
    ...
    Cenario: Delete para apagar Registration com sucesso
      ...
      Entao receberei um ResponseEntity com HTTP 204 do RegistrationController
